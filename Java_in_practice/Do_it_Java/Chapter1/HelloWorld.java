...
// package는 파이썬의 package와 동일하다고 생각. 파일들을 모아 관리하는 디렉토리이다.
// 즉, package는 소스의 계층 구조를 관리하기 위한 것으로, 이를 통해 소스 코드 관리와 유지 보수가 편리하다.
...
public class HelloWorld { // first.HelloWorld 가 본래 이름.
	// 따라서 패키지를 통해 동일한 이름을 가진 클래스를 구별할 수 있다.
